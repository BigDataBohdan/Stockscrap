...
self_inf = {
    'Name': 'Bohdan',
    'Email': 'bohdankvietka0@gmail.com'
}
...
for page_number in range(1, 155):
    url = 'https://www.centralcharts.com/en/price-list-ranking/ALL/asc/ts_19-us-nasdaq-stocks--qc_1-alphabetical-order?p=' + str(page_number)
    pages.append(url)
